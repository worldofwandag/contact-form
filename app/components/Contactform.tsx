...
const Contactform = () => {
  return (
    <div className="card__container flex flex-col bg-white min-h-[773px] w-[736px] rounded-[16px] p-[40px] ">
        ...
        <div className="card__fields flex flex-col ">
          ...
          <div className="query__type w-full h-[91px] mb-[24px]">
            ...
            <div className="query__boxes flex flex-row w-full justify-between">
              ...
              <div className="query__support w-[320px] h-[51px] query__box flex flex-row items-center">
                <Image
                  src={radioDeselect}
                  alt="radio deselect"
                  width={24}
      ...
      {/* submit */}
      <button className="submit__button w-full h-[59px] rounded-[8px] bg-[#2A4144] text-white text-[18px] font-bold leading-[150%]">
        Submit
      </button>
    </div>
  );
